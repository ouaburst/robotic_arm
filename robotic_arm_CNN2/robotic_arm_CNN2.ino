...
float angleaData[] = {-50.53,-50.53,58.34,-50.53 ,0,0};
float anglebData[] = {160.62,271.46,162.54, 160.62 ,180.0,180.0};
float anglecData[] = {250.08,139.24,139.24, 250.08,180.0,180.0};
float angledData[] = {0,0,0,-70,-70,0};
